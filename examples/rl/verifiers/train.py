...
"""
inference:
CUDA_VISIBLE_DEVICES=0 uv run vf-vllm --model Qwen/Qwen3-0.6B

training:
CUDA_VISIBLE_DEVICES=1 uv run accelerate launch --num-processes 1 --config-file examples/rl/verifiers/configs/zero3.yaml examples/rl/verifiers/train.py
"""
