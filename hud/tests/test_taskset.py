...
from hud.taskset import TaskSet, load_taskset, load_from_inspect
...
def sample_tasks():
    ...
    return [
        ...
        Task(
            ...
            prompt="Test task 2",
            gym="qa",
            evaluate=("response_includes", "answer")
        ),
        Task(
            id="task-3",
...
def sample_taskset(sample_tasks):
    ...
    return TaskSet(
        id="test-taskset-123",
        description="Test TaskSet for unit tests",
        tasks=sample_tasks
    )
